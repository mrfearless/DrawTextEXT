...
* Download the latest version of the DrawTextEXT release and extract the files. The latest release can be found in the [Release](https://github.com/mrfearless/DrawTextEXT/tree/master/release) folder, or can be downloaded directly from [here](https://github.com/mrfearless/DrawTextEXT/blob/master/release/DrawTextEXT.zip?raw=true).
...
A RadASM example project is included to demonstrate the `DrawHTMLCODE` function.
